...
get the app created:
    ...
    $ heroku apps:create nextbus
    Creating nextbus... done, stack is cedar
    http://nextbus.herokuapp.com/ | git@heroku.com:nextbus.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://nextbus.herokuapp.com deployed to Heroku

    To git@heroku.com:nextbus.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://nextbus.herokuap.com
    ["Hello" :from Heroku]
